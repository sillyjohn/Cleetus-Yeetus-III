class aitesting extends Phaser.Scene {
    constructor(){
        super("aitesting");
...
create(){
   ...
   // tile map
    ...
    //create exit
    this.levelExit = this.map.findObject("Object Layer_level_3", obj => obj.name  === "level_3_Exit");
    ...
    //bug enemy spawn
    this.enemySpawnPoint = this.map.findObject("Object Layer_level_3", obj => obj.name  === "enemySpawn");
    ...
    this.enemy_Shroom = new Mushroom(this,this.enemySpawnPoint_shroom.x,this.enemySpawnPoint_shroom.y,'mushroomSprite');
    this.enemy_Shroom.body.setCollideWorldBounds(true);
    ...
    this.physics.world.TILE_BIAS= 50;
    this.physics.add.collider(this.player, this.enemy_Bug, (obj1, obj2) => {
...
//     var distX = this.enemy_Bug.x - this.player.x;
//     var distY = this.enemy_Bug.y - this.player.y;
//     console.log('x '+ distX)
//     console.log('y'+ distY)
//     if (distX > 700||-distX < -700||distY < 700||-distY > -700)
//         {
//             this.enemy_Bug.setVisible(true);
//             this.enemy_Bug.setActive(true);
//         console.log('player in range');
//     }
            
//     else {
//         this.enemy_Bug.setActive(false);
//         this.enemy_Bug.setVisible(false)
//     }
...
update(){
    ...
    this.enemy_Bug.update();
  

    //reticle movement
    this.constrainReticle(this.reticle);
    this.enemy_Bug.enemyAppear(this.enemy_Bug.x,this.enemy_Bug.y,this.player.x,this.player.y);
